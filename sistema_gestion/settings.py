...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'templates'],  # Añadimos la carpeta de templates
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [BASE_DIR / 'static']  # Añadimos la carpeta de archivos estáticos
...
LOGIN_REDIRECT_URL = 'dashboard'  # Redirige después del login
